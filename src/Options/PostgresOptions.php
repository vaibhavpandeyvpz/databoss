 ...
 *
 * Fluent builder for PostgreSQL connection options.
 */
class PostgresOptions
{
     ...
     * Constructor.
     *
     * Initializes with PostgreSQL driver and default values.
     */
    public function __construct()
    {
        $this->options = [
            ConnectionAbstract::OPT_DRIVER => DatabaseDriver::POSTGRES->value,
