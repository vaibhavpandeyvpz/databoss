 ...
 * Class SqlsrvOptions
 *
 * Fluent builder for SQL Server connection options.
 */
class SqlsrvOptions
{
     ...
     * Constructor.
     *
     * Initializes with SQL Server driver and default values.
     */
     ...
     *
     * @param  string  $charset  The database charset (default: 'UTF-8')
     * @return self Returns self for method chaining
     */
